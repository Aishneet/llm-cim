...
NEW_NUM_LAYERS = 1
EXPORT_DECODE_PATH = "Decode_linalg2_gpt2_large_4096.mlir"
DEVICE = "cpu"
...
def load_weights_from_hf(custom_model, name):
    ...
    # Only weights used by this no-GEMV model
    mapping = {
    ...
    custom_pos = custom_state_dict["pos_emb.weight"]      # [2048, emb_dim]
